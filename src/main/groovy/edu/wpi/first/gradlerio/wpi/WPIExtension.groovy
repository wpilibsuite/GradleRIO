...
class WPIExtension {
    ...
    String wpilibVersion = "2019.3.1"
    String niLibrariesVersion = "2019.12.1"
    String opencvVersion = "3.4.4-4"
    static final String[] validImageVersions = ['2019_v12', '2019_v13', '2019_v14']
    ...
    String smartDashboardVersion = "2019.3.1"
    String shuffleboardVersion = "2019.3.1"
    String outlineViewerVersion = "2019.3.1"
    String robotBuilderVersion = "2019.3.1"
