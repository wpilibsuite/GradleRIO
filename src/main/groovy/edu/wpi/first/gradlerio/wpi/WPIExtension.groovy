...
class WPIExtension {
    ...
    String smartDashboardVersion = "2020.2.1"
    String shuffleboardVersion = "2020.2.1"
    String outlineViewerVersion = "2020.2.1"
    String robotBuilderVersion = "2020.2.1"
    String pathWeaverVersion = "2020.2.1"
