...
class WPIExtension {
    ...
    String smartDashboardVersion = "2020.2.2"
    String shuffleboardVersion = "2020.2.2"
    String outlineViewerVersion = "2020.2.2"
    String robotBuilderVersion = "2020.2.2"
    String pathWeaverVersion = "2020.2.2"
