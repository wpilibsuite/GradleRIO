...
class FRCVisionPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        def debugInfoLazy = project.tasks.register("frcvisionWriteDebugInfo", DebugInfoTask, { DebugInfoTask t ->
            t.finalizedBy(project.tasks.withType(DebugInfoMergeTask))
        } as Action<DebugInfoTask>)
        def frcExt = project.extensions.create("frcvision", FRCVisionExtension, project)

        project.tasks.register("frcvisionMergeDebugInfo", DebugInfoMergeTask, { DebugInfoMergeTask t ->
