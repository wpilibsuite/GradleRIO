...
public abstract class WPIVersionsExtension {
    ...
    private static final String outlineViewerVersion = "2027.0.0-alpha-6-336-g92efd74d9";
    private static final String glassVersion = "2027.0.0-alpha-6-336-g92efd74d9";
    private static final String sysIdVersion = "2027.0.0-alpha-6-336-g92efd74d9";
    private static final String dataLogToolVersion = "2027.0.0-alpha-6-336-g92efd74d9";
    private static final String wpicalToolVersion = "2027.0.0-alpha-6-336-g92efd74d9";
    private static final String processstarterToolVersion = "2027.0.0-alpha-6-336-g92efd74d9";
