...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2027.0.0-alpha-6-364-g18ae9bd4e";
    ...
    private static final String outlineViewerVersion = "2027.0.0-alpha-6-364-g18ae9bd4e";
    private static final String glassVersion = "2027.0.0-alpha-6-364-g18ae9bd4e";
