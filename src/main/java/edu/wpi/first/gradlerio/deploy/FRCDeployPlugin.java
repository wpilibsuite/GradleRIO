...
public class FRCDeployPlugin implements Plugin<Project> {
  ...
  public void apply(Project project) {
    ...
    FRCExtension frcExtension =
        project.getExtensions().create("frc", FRCExtension.class, project, deployExtension);
        ...
        .registerFactory(
            ...
            name -> {
              RoboRIO target =
                  project
                      .getObjects()
                      .newInstance(RoboRIO.class, name, project, deployExtension, frcExtension);
  ...
  public static void ownDirectory(DeployContext ctx, String directory) {
    ctx.execute(
        "chmod -R 777 \"" + directory + "\" || true; chown -R lvuser:ni \"" + directory + "\"");
  }
