...
public class WPIToolsPlugin implements Plugin<Project> {
  ...
  public void apply(Project project) {
    ...
    String toolsClassifier =
        project.getExtensions().getByType(WPIExtension.class).getToolsClassifier();
    if (!toolsClassifier.equals("macarm64")) {
      tools.add(
          new WPITool(
              project,
              "SmartDashboard",
              wpi.getVersions().getSmartDashboardVersion(),
              "edu.wpi.first.tools",
              "SmartDashboard",
              true,
              toolsFolder));
    ...
    tools.add(
        new WPITool(
            project,
            "ShuffleBoard",
            wpi.getVersions().getShuffleboardVersion(),
            "edu.wpi.first.tools",
            "Shuffleboard",
            true,
            toolsFolder));
    tools.add(
        new WPITool(
            project,
            "RobotBuilder",
            wpi.getVersions().getRobotBuilderVersion(),
            "edu.wpi.first.tools",
            "RobotBuilder",
            false,
            toolsFolder));
    tools.add(
        new WPITool(
            project,
            "PathWeaver",
            wpi.getVersions().getPathWeaverVersion(),
            "edu.wpi.first.tools",
            "PathWeaver",
            true,
            toolsFolder));
    ...
    cppTools.add(
        new WPICppTool(
            project,
            "OutlineViewer",
            wpi.getVersions().getOutlineViewerVersion(),
    ...
    cppTools.add(
        new WPICppTool(
            project,
            "Glass",
            wpi.getVersions().getGlassVersion(),
    ...
    cppTools.add(
        new WPICppTool(
            project,
            "SysId",
            wpi.getVersions().getSysIdVersion(),
    ...
    cppTools.add(
        new WPICppTool(
            ...
            wpi.getVersions().getRoboRIOTeamNumberSetterVersion(),
    ...
    cppTools.add(
        new WPICppTool(
            project,
            "DataLogTool",
            wpi.getVersions().getDataLogToolVersion(),
