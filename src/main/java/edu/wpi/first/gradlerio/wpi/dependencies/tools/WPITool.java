...
public class WPITool implements Named {
  ...
  public WPITool(
      ...
      String groupId,
      String artifactName,
      boolean platformJars,
      Provider<Directory> toolsFolder) {
    ...
    toolInstallTask =
        project.getTasks().register(name + "Install".toString(), ToolInstallTask.class);
    toolInstallTask.configure(
        t -> {
