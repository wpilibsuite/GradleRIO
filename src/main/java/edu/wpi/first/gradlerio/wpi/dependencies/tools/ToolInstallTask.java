...
public class ToolInstallTask extends DefaultTask {
  ...
  private static final Type mapType = new TypeToken<List<ToolConfig>>() {}.getType();
  ...
  private static synchronized Optional<ToolConfig> getExistingToolVersion(
      Directory toolsFolder, String toolName) {
    // Load JSON file
