...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2026.2.1";
    private static final String niLibrariesVersion = "2026.1.2";
    ...
    private static final String wpimathVersion = "2026.2.1";

    private static final String smartDashboardVersion = "2026.2.1";
    private static final String shuffleboardVersion = "2026.2.1";
    private static final String outlineViewerVersion = "2026.2.1";
    private static final String robotBuilderVersion = "2026.2.1";
    private static final String pathWeaverVersion = "2026.2.1";
    private static final String glassVersion = "2026.2.1";
    private static final String sysIdVersion = "2026.2.1";
    private static final String roboRIOTeamNumberSetterVersion = "2026.2.1";
    private static final String dataLogToolVersion = "2026.2.1";
    private static final String wpicalToolVersion = "2026.2.1";
    private static final String processstarterToolVersion = "2026.2.1";
