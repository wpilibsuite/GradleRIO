...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2022.1.1";
    ...
    private static final String wpimathVersion = "2022.1.1";
    private static final String googleTestVersion = "1.9.0-5-437e100-1";

    private static final String smartDashboardVersion = "2022.1.1";
    private static final String shuffleboardVersion = "2022.1.1";
    private static final String outlineViewerVersion = "2022.1.1";
    private static final String robotBuilderVersion = "2022.1.1";
    private static final String robotBuilderOldVersion = "2022.1.1";
    private static final String pathWeaverVersion = "2022.1.1";
    private static final String glassVersion = "2022.1.1";
    private static final String sysIdVersion = "2022.1.1";
    private static final String roboRIOTeamNumberSetterVersion = "2022.1.1";
