...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2027.0.0-alpha-1";
    ...
    private static final String wpimathVersion = "2027.0.0-alpha-1";

    private static final String outlineViewerVersion = "2027.0.0-alpha-1";
    private static final String glassVersion = "2027.0.0-alpha-1";
    private static final String sysIdVersion = "2027.0.0-alpha-1";
    private static final String dataLogToolVersion = "2027.0.0-alpha-1";
