...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2023.1.1-beta-7";
    private static final String niLibrariesVersion = "2023.2.1";
    ...
    private static final String wpimathVersion = "2023.1.1-beta-7";
    private static final String googleTestVersion = "1.12.1-1";

    private static final String smartDashboardVersion = "2023.1.1-beta-7";
    private static final String shuffleboardVersion = "2023.1.1-beta-7";
    private static final String outlineViewerVersion = "2023.1.1-beta-7";
    private static final String robotBuilderVersion = "2023.1.1-beta-7";
    private static final String pathWeaverVersion = "2023.1.1-beta-7";
    private static final String glassVersion = "2023.1.1-beta-7";
    private static final String sysIdVersion = "2022.4.1";
    private static final String roboRIOTeamNumberSetterVersion = "2023.1.1-beta-7";
    private static final String dataLogToolVersion = "2023.1.1-beta-7";
