...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2025.3.2";
    ...
    private static final String wpimathVersion = "2025.3.2";

    private static final String smartDashboardVersion = "2025.3.2";
    private static final String shuffleboardVersion = "2025.3.2";
    private static final String outlineViewerVersion = "2025.3.2";
    private static final String robotBuilderVersion = "2025.3.2";
    private static final String pathWeaverVersion = "2025.3.2";
    private static final String glassVersion = "2025.3.2";
    private static final String sysIdVersion = "2025.3.2";
