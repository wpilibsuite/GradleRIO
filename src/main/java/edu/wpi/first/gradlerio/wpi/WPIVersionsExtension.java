...
public abstract class WPIVersionsExtension {
    ...
    private static final String wpilibVersion = "2025.3.2-169-gf99692f";
    ...
    private static final String wpimathVersion = "2025.3.2-169-gf99692f";

    private static final String outlineViewerVersion = "2025.3.2-169-gf99692f";
    private static final String glassVersion = "2025.3.2-169-gf99692f";
    private static final String sysIdVersion = "2025.3.2-169-gf99692f";
    private static final String dataLogToolVersion = "2025.3.2-169-gf99692f";
