...
public abstract class WPIVersionsExtension {
  ...
  private static final String wpilibVersion = "2024.1.1-beta-3";
  ...
  private static final String wpimathVersion = "2024.1.1-beta-3";
  private static final String googleTestVersion = "1.14.0-1";

  private static final String smartDashboardVersion = "2024.1.1-beta-3";
  private static final String shuffleboardVersion = "2024.1.1-beta-3";
  private static final String outlineViewerVersion = "2024.1.1-beta-3";
  private static final String robotBuilderVersion = "2024.1.1-beta-3";
  private static final String pathWeaverVersion = "2024.1.1-beta-3";
  private static final String glassVersion = "2024.1.1-beta-3";
  private static final String sysIdVersion = "2024.1.1-beta-3";
  private static final String roboRIOTeamNumberSetterVersion = "2024.1.1-beta-3";
  private static final String dataLogToolVersion = "2024.1.1-beta-3";
