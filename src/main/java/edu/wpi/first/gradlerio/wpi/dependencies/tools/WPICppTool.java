...
public class WPICppTool implements Named {
  ...
  public WPICppTool(
    ...
    String toolsClassifier =
        project.getExtensions().getByType(WPIExtension.class).getCppToolsClassifier();
    ...
    // toolInstallTask = project.tasks.register("${name}Install".toString(), CppToolInstallTask,
