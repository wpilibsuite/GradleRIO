...
First install buildship the gradle plugin made by Eclipse for the Eclipse IDE. Installtion instructions can be found here: https://github.com/eclipse/buildship/blob/master/docs/user/Installation.md
